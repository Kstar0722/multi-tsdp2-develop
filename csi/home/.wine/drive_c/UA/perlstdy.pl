...
# @UAIndicatorDisplayFormat = ('%.4lfL','%.4lfL','%.4lfL','%.4lfL','%.4lfL','%.4lfL','%.4lfL','%.4lfL','%.4lfL','%.4lfL');
  @UAIndicatorLabels        = ('DaB4Cl','ToDaCl','Zscore');
  @UAIndicatorDisplayFormat = ('%.4lfL','%.4lfL','%.4lfL');
...
sub study { Correlation(250); }
  my($UA_IsChartStudy)= 1;
  my($UA_OptimizationCount)= 0;
  my($UA_OptBalancing)= 1081247744;
  my($UA_SmartOptimize)= 0;
  my($UA_OptObjectiveDirection)= 201;
  my($UA_OptObjectiveField)= -1;
  my(@UAOptimizationDimensions) = ();
  my(@UAOptimizationMinValues) = ();
  my(@UAOptimizationStepValues) = ();
use Win32::OLE;
